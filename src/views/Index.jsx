...
const Index = () => {
  ...
  return (
          ...
          >
            ...
            <div className={`${IndexCss.nameBox}`}>
              ...
              <p className={`${IndexCss.comment}`}>
                {question.commentBox.length > 9
                  ? `${9}+`
                  : question.commentBox.length >= 0
                  ? question.commentBox.length
                  : 0}
              </p>
            </div>
          </Link>
    ...
    <div className={`${IndexCss.arrowBox}`}>
      <div
        className={`${IndexCss.left} ${IndexCss.arrow}`}
      ...
      <ul className={`${IndexCss.pageNation}`}>
        {Array.from({ length: totalPages }, (_, index) => (
          <li
            key={index}
            className={`${IndexCss.page} ${
              index === currentPage ? IndexCss.curPage : ""
            }`}
      ...
      <div
        className={`${IndexCss.right} ${IndexCss.arrow}`}
